...
#man h1 {
	background: url("http://nodejs.org/logo.png") no-repeat scroll center 0
		transparent;
	height: 111px;
	margin: 15px 0 20px;
	text-align: center;
...
about completing it.  <code>.break</code> will start over.</p></li><li><p><code>.clear</code> - Resets the <code>context</code> object to an empty object and clears any multi-line expression.</p></li><li><p><code>.exit</code> - Close the I/O stream, which will cause the REPL to exit.</p></li><li><p><code>.help</code> - Show this list of special commands.</p></li></ul>
...
<h2 id="Appendix - Third Party Modules">Appendix - Third Party Modules</h2>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/res/js/sh_main.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/res/js/sh_javascript.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/res/js/doc.js"></script>