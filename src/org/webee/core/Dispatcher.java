...
public class Dispatcher implements Filter {
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		try {
			...
			if (js.getString("exclude") != null)
				this.exts = js.getString("exclude").split(",");
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if (isOpen(requestURI, exts)) {
			...
			try {
				...
				String viewPath = ("/view/" + obj.theme + "/" + controllerPath
						+ "/" + action + ".jsp").toLowerCase();
				if (obj.redirectPath != null) {
					res.sendRedirect(obj.redirectPath);
				} else {
					if (obj.viewPath != null) {
						if (obj.viewPath.startsWith("/")) {
							...
							viewPath = ("/view/" + obj.theme + "/" + controllerPath
									+ "/" + obj.viewPath + ".jsp").toLowerCase();
						}
					}
	...
	public boolean isOpen(String path, String[] exts) {
		if (exts != null) {
